      ...
      <div className="card my-card" id="fav-card" style={{ width: '22rem', display: 'flex', flexDirection: 'column', height: '440px',marginRight:'10%' }}>
        ...
        <h3 className="card-title text-center" style={{ color: '#3993DD', marginTop: '-30px', display: 'flex', flexDirection: 'column', height: '40px', lineHeight: '30px' }}>
          ...
          <div className="mt-auto d-flex justify-content-center">
            <a href='' className="btn btn-dark d-flex justify-content-center align-items-center mx-2" style={{ backgroundColor: 'white', minWidth: '145px', fontSize: '0.85rem', height: '35px', lineHeight: '15px' }}>
               Watch Demo
            </a>
            <a href="https://usefulbicorp.sharepoint.com/:b:/s/UBIDemoWebsite/EY4yK4RFJLhEqwJ6v3MS3UsByjm3IB3bMUSDuEAy0wr3pg" className="btn btn-dark d-flex justify-content-center align-items-center mx-2" style={{ backgroundColor: 'white', minWidth: '145px', fontSize: '0.85rem' }}>
              Know More
            </a>
          </div>
        </div>
